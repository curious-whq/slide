...
out_path = "/home/whq/Desktop/code_list/perple_test/all_allow_litmus_C910_fence_timebase"
in_path = "/home/whq/Desktop/code_list/perple_test/all_allow_litmus_C910_naive"
...
if __name__ == "__main__":
    ...
    for litmus_file in litmus_files:
        ...
        # cmd += f" -o {chip_dir}"
        # print(cmd)
        cmd = f"mkdir -p {out_path}/{litmus_name};eval $(opam env); litmus7 -carch RISCV -limit true -mem indirect -affinity incr1 -force_affinity true -barrier userfence -stride 1 -size_of_test 100 -number_of_run 10 -driver C -ccopts -O2 -gcc riscv64-unknown-linux-gnu-gcc -linkopt -static -smtmode seq -smt 2  -avail 4 "
