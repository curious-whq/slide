...
"0:\n"
"#END _litmus_P1\n\t"
:[x11] "=&r" (out_1_x11[_i]),[x9] "=&r" (out_1_x9[_i]),[x5] "=&r" (out_1_x5[_i]),[x13] "=&r" (trashed_x13),[x10] "=&r" (trashed_x10),[x7] "=&r" (trashed_x7)
:[x6] "r" (&_a->y[_i]),[x8] "r" (&_a->z[_i]),"[x9]" (0),"[x11]" (0),[x12] "r" (&_a->x[_i])
:"cc","memory"
);
    }
  }
